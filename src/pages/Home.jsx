...
export default function Home() {
  ...
  const steps = [
    ...
    },
    {
      kind: "image",
      src: {
        desktop: "images/31.jpg",
        mobile: "images/31.jpg",
      },
    ...
    },
    {
      ...
      ctaText: "Shop MEN",
      ctaHref:
        "/products/list?page=1&sort=created_at&primary=MEN&item=아우터&category_id=3fc714e3-8af1-4d06-a7c1-64f49c740e40",
    },
    {
      kind: "image",
      src: {
        desktop: "images/5.jpg",
        mobile: "images/5.jpg",
      },
      ...
      ctaText: "Shop WOMEN",
      ctaHref:
        "/products/list?page=1&sort=created_at&primary=WOMEN&item=긴팔&category_id=4483dd0f-7329-4cb2-a9a6-2b531e35682c",
    },
    {
      kind: "image",
      src: {
        desktop: "images/32.jpg",

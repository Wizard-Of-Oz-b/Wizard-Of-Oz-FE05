...
export default function CouponFilters({
  ...
  setToday, setThisWeek, setThisMonth, clearRange,
}) {
  return (
      ...
      <div className="md:col-span-2">
        <div className="flex items-center justify-between mb-1.5">
          ...
          <div className="flex gap-1">
            <button onClick={setToday} className="rounded-lg bg-gray-100 text-xs px-2 py-1 hover:bg-gray-200">오늘</button>
            <button onClick={setThisWeek} className="rounded-lg bg-gray-100 text-xs px-2 py-1 hover:bg-gray-200">이번주</button>
            <button onClick={setThisMonth} className="rounded-lg bg-gray-100 text-xs px-2 py-1 hover:bg-gray-200">이번달</button>
            <button onClick={clearRange} className="rounded-lg bg-gray-100 text-xs px-2 py-1 hover:bg-gray-200">초기화</button>
          </div>
        </div>

...
export default function SearchRow({ active, keyword, setKeyword, inputRef, onSubmit }) {
  return (
    <form onSubmit={onSubmit} className="mx-auto max-w-[120rem] px-6 pt-5 flex items-center gap-3">
      <motion.div className="relative flex-1" variants={fadeUp}>
      ...
      <motion.button type="submit" className="px-4 py-2 rounded-full bg-black text-white text-sm font-semibold hover:bg-black/90" variants={fadeUp}>
        검색
      </motion.button>
    </form>
  );
